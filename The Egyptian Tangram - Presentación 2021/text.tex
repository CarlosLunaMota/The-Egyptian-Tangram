...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %% Colors
    \usebackgroundtemplate{\includegraphics[height=\paperheight]{pictures/Barra Hex.png}}
...
\author{
    \includegraphics[height=20ex]{figures/figure001a.pdf}\\[-0.25ex]
    {\small \href{https://creativecommons.org/licenses/by-nc-sa/4.0/}{\includegraphics[scale=0.15]{pictures/cc.pdf}\includegraphics[scale=0.15]{pictures/by.pdf}\includegraphics[scale=0.15]{pictures/nc.pdf}\includegraphics[scale=0.15]{pictures/sa.pdf}} \href{https://github.com/CarlosLunaMota}{Carlos Luna-Mota}}\\
    \vspace{0.55em}
    \href{https://mmaca.cat/}{\includegraphics[height=3ex]{pictures/logo.png}}
...
\begin{document}
    ...
    \begin{frame}{Tangram - Siluetas}
        \begin{center}
            \includegraphics[height=15ex]{figures/ffigura002a.pdf} \quad \phantom{\includegraphics[height=15ex]{figures/ffigura002b.pdf}} \\
        \end{center}
    \end{frame}
    ...
    \begin{frame}{}
        \begin{center}
            \textbf{\huge Tangrams educativos}
        \end{center}
    \end{frame}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    \begin{frame}{Tangrams educativos}
        \begin{center}
            \includegraphics[height=13ex]{figures/ffigura030c.pdf}\qquad\includegraphics[height=13ex]{figures/ffigura010c.pdf}\qquad\includegraphics[height=13ex]{figures/ffigura030d.pdf} \\

            \vspace{1em}

            {\small\begin{minipage}{0.8\textwidth}
                \begin{itemize}
                    \item Pocas piezas y geométricamente sencillas
                    \item Piezas de área similar y ángulos no muy agudos
                    \item Piezas diferentes y asimétricas
                    \item Lados y ángulos compatibles
                \end{itemize}
            \end{minipage}}
        \end{center}
    ...
    \begin{frame}{Tangrams educativos - Conmensurabilidad}
        \begin{center}
            \includegraphics[height=13ex]{figures/ffigura012d.pdf}\qquad\includegraphics[height=13ex]{figures/ffigura012c.pdf}\qquad\includegraphics[height=13ex]{figures/ffigura012e.pdf} \\
        \end{center}
        \vskip0ptplus1filll\relax
    \end{frame}
    ...
    \begin{frame}{Tangrams educativos - Conmensurabilidad}
        \begin{center}
            ...
            \includegraphics[height=13ex]{figures/ffigura013d.pdf}\qquad\includegraphics[height=13ex]{figures/ffigura013c.pdf}\qquad\includegraphics[height=13ex]{figures/ffigura013e.pdf} \\
        \end{center}
        \vskip0ptplus1filll\relax
    \end{frame}
    ...
    \begin{frame}{}
        \begin{center}
            ...
            \textbf{\large un nuevo tangram \emph{made in} MMACA}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Un corte interesante}
        \begin{center}
            \includegraphics[height=15ex]{figures/ffigura014.pdf}\qquad\qquad\phantom{\includegraphics[height=15ex]{figures/ffigura013b.pdf}} \\
    ...
    \begin{frame}{Un corte interesante}
        \begin{center}
            \includegraphics[height=15ex]{figures/ffigura014.pdf}\qquad\qquad\includegraphics[height=15ex]{figures/ffigura016d.pdf} \\
    ...
    \begin{frame}{Divulgando el tangram egipcio}
        \begin{center}
            ...
            \end{minipage}\quad\begin{minipage}{0.4\textwidth}
                \fbox{\includegraphics[height=30ex]{pictures/Diari de disseny - p01.pdf}}
            \end{minipage}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Divulgando el tangram egipcio}
        \begin{center}
            \fbox{\includegraphics[height=25ex]{pictures/Parlem de tangrams - p01.pdf}} \\\medskip
    ...
    \begin{frame}{Divulgando el tangram egipcio}
        \begin{center}
            ...
            \end{minipage}\quad\begin{minipage}{0.4\textwidth}
                \fbox{\includegraphics[height=30ex]{pictures/L'Esquitx 43 desembre 2020 - p21.pdf}}
            \end{minipage}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Divulgando el tangram egipcio}
        \begin{center}
            \fbox{\includegraphics[height=25ex]{pictures/El Tangram Egipcio 2021 - p01.pdf}} \\\medskip
