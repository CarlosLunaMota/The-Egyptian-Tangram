...
\begin{document}
    ...
    \begin{frame}{Geometric figures}
        ...
        \begin{center}
            ...
            \begin{tabular}{lccc}
                  \raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022a.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022j.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022c.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022l.pdf}} \\[1.0ex]
                  \raisebox{1.0ex}{\includegraphics[scale=0.25]{figures/figure022b.pdf}} \;&
                \;\raisebox{0.8ex}{\includegraphics[scale=0.25]{figures/figure022m.pdf}} \;&
                \;\raisebox{0.8ex}{\includegraphics[scale=0.25]{figures/figure022i.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022p.pdf}} \\[0.750ex]
                  \raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022e.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022n.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022h.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022t.pdf}} \\[1.5ex]
                  \raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022d.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022k.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022g.pdf}} \;&
                \;\raisebox{0.0ex}{\includegraphics[scale=0.25]{figures/figure022q.pdf}} \\
            \end{tabular}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Realistic figures}
        ...
        \begin{center}
            ...
            {\footnotesize
            \begin{tabular}{ccccc}
                \includegraphics[scale=0.22]{figures/figure026a.pdf}\;\; &
                \includegraphics[scale=0.22]{figures/figure026p.pdf} &
                \includegraphics[scale=0.22]{figures/figure026b.pdf} &
                \includegraphics[scale=0.22]{figures/figure026f.pdf} &
                \includegraphics[scale=0.22]{figures/figure026d.pdf}\\
                Viking hat & Candle & Snowmobile & Diamond & Whale tail\\[3ex]
                \includegraphics[scale=0.22]{figures/figure026e.pdf} &
                \includegraphics[scale=0.22]{figures/figure026c.pdf} &
                \includegraphics[scale=0.22]{figures/figure026g.pdf} &
                \includegraphics[scale=0.22]{figures/figure026h.pdf} &
                \includegraphics[scale=0.22]{figures/figure026q.pdf}\\
                Alpine House & Sailboat & Erlenmeyer & Teddy bear & Penguin\\[4ex]
            \end{tabular}
    ...
    \begin{frame}{The Erlenmeyer paradox!}
        \begin{center}
            ...
            \raisebox{5ex}{\includegraphics[scale=0.2]{figures/figure022t.pdf}}\qquad
    ...
    \begin{frame}{References}
        \begin{center}
            ...
            \begin{itemize}
                ...
                \item Bogomolny -- \emph{``\href{https://www.cut-the-knot.org/}{Cut The Knot}''} (1996--2018)
...
\end{document}
    ...
    \begin{frame}{Ackoledgements}
        \begin{center}
            This document was the product of the colaboration of all MMACA team
