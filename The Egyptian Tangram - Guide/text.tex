...
\begin{document}
    ...
    \begin{frame}{Tangent circles}
        \begin{center}
            The circumcircle of that Egyptian Triangle...
        \end{center}
        \hspace{5.15em} \includegraphics[scale=1.0]{figures/figure009k.pdf} \\
        \vspace{-1em}
        \begin{center}
             ...is tangent to the top side of the square
        \end{center}
        \vspace{-1.5em}
    \end{frame}
    ...
    \begin{frame}{Tangent circles}
        \begin{center}
            That circle is also...
        \end{center}
        \hspace{5.18em} \includegraphics[scale=1.0]{figures/figure009l.pdf} \\
        \vspace{-1em}
        \begin{center}
             ...the circumcircle of this $1\!\!:\!\!2\!\!:\!\!\sqrt{5}$ triangle
        \end{center}
        \vspace{-1.75em}
    \end{frame}
