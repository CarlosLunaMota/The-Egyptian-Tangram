...
\begin{document}
    ...
    \begin{frame}{Promissing features}
        \begin{center}
    ...
    \begin{frame}{Why we called it the \emph{Egyptian} Tangram?}
        \begin{center}
            ...
            ...an \textbf{Egyptian} Triangle ($3\!\!:\!\!4\!\!:\!\!5$)\\{\small and, hence, the name of this tangram}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{The Egyptian Four--Triangle--Tangram}
        \begin{center}
            ...
            \bigskip
            You can use this figure to prove these indentities:
            \bigskip
    ...
    \begin{frame}{The Egyptian Four--Triangle--Tangram}
        \begin{center}
            ...
            \bigskip
            You can use these figures to prove these indentities:
            \bigskip
    ...
    \begin{frame}{The Egyptian Three--Triangle--Tangram}
        \begin{center}
            ...
            and use them to prove the \textbf{Altitude Theorem}: {\footnotesize $h^{2} = x\cdot y$}\\and the \textbf{Leg Theorems}: {\footnotesize$a^{2} = x\cdot c$\quad \&\quad $b^{2} = y\cdot c$}}
    ...
    \begin{frame}{The Egyptian Three--Triangle--Tangram}
        \begin{center}
            ...
            {\small ...and you can use this figure to prove the \textbf{AM-GM Inequality}:\\\medskip$\displaystyle\frac{a+b}{2} \geq \sqrt{\!ab}$}\\
    ...
    \begin{frame}{Divulgation of the Egyptian Tangram}
        \begin{center}
            \includegraphics[height=28ex]{pictures/Prototipe.png}\qquad\\

            \medskip

            Wooden prototipe for MMACA's exhibitions (2019)
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Divulgation of the Egyptian Tangram}
        \begin{center}
            \begin{minipage}{0.5\textwidth}
                Design diary at Nou Biaix magazine 44 (2019)
    ...
    \begin{frame}{Divulgation of the Egyptian Tangram}
        \begin{center}
            ...
            \end{minipage}\quad\begin{minipage}{0.5\textwidth}
                Print-\&-play flyer for families affected by CoVID-19  (2020)
            \end{minipage}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Divulgation of the Egyptian Tangram}
        \begin{center}
            \begin{minipage}{0.5\textwidth}
                The Egyptian Tangram as a highschool learning activity (2020)
            \end{minipage}\quad\begin{minipage}{0.4\textwidth}
    ...
    \begin{frame}{Divulgation of the Egyptian Tangram}
        \begin{center}
            ...
            On-line talks for FUNDAPROMAT and\\ MMACA's 7th aniversary (2021)
        \end{center}
    \end{frame}
    ...
    \begin{frame}{References}
        \begin{center}
            ...
            \begin{itemize}
                ...
                \item Nelsen, R. B. \& Alsina, C. -- \emph{``Icons of Mathematics''} (2011)
