...
\begin{document}
    ...
    \begin{frame}{Geometric figures}
        ...
        \begin{center}
            ...
            {\normalsize Complete the cycle moving a different piece at a time}

            \bigskip\medskip

            \begin{tabular}{ccccccc}
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026l.pdf}} & \!\!\raisebox{1.5ex}{$\boldsymbol{\rightarrow}$}\!\! &
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026m.pdf}} &  &
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026b.pdf}} & \!\!\raisebox{1.5ex}{$\boldsymbol{\rightarrow}$}\!\! &
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026c.pdf}} \\
                $\boldsymbol{\uparrow}$ & & $\boldsymbol{\downarrow}$ & & $\boldsymbol{\uparrow}$ & & $\boldsymbol{\downarrow}$ \\
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026k.pdf}} & & \multicolumn{3}{c}{\multirow{3}{*}{\raisebox{2.0ex}{\includegraphics[scale=0.60]{figures/figure026.pdf}}}} & &
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026d.pdf}} \\
                $\boldsymbol{\uparrow}$ & & \multicolumn{3}{c}{} & & $\boldsymbol{\downarrow}$ \\
                ...
                $\boldsymbol{\uparrow}$ & & & & & & $\boldsymbol{\downarrow}$ \\
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026i.pdf}} & \!\!\raisebox{1.5ex}{$\boldsymbol{\leftarrow}$}\!\! &
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026h.pdf}} & \!\!\raisebox{1.5ex}{$\boldsymbol{\leftarrow}$}\!\! &
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026g.pdf}} & \!\!\raisebox{1.5ex}{$\boldsymbol{\leftarrow}$}\!\! &
                \raisebox{0.0ex}{\includegraphics[scale=0.2]{figures/figure026f.pdf}} \\
            \end{tabular}
    ...
    \begin{frame}{Geometric figures}
        \begin{center}
            ...
            \includegraphics[width=0.9\textwidth]{figures/figure022d.pdf}
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Geometric figures}
        \begin{center}
            ...
            ...and then try to find the solution that also has\\the vertices of all 5 pieces lying on the same grid.
        \end{center}
    \end{frame}
    ...
    \begin{frame}{Figures with no solution}
        \begin{center}
            {Could you explain why some of these rectangles can not be solved?}
