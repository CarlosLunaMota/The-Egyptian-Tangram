...
\begin{document}
    ...
    \begin{frame}{Geometric figures}
        \begin{center}        
            ...
            \end{minipage}\hfill\begin{minipage}{0.49\textwidth} \small
                ...
                Moreover, their solutions can be drawn with the vertices of all 5 pieces lying on the same lattice.
        ...
        \begin{center}        
            ...
            \end{minipage}\hfill\begin{minipage}{0.49\textwidth} \footnotesize
                ...
                \hspace{-0.5em}\begin{tabular}{ll}                
                    ...
                    Bottom    & $\!\!\!\!\!= \sqrt{3^2 + 6^2} = \sqrt{45} = 3\sqrt{5}$ \\[1.5ex]
                    Right     & $\!\!\!\!\!= 5$ \quad (just count them!)               \\[4ex]
                    Perimeter & $\!\!\!\!\!= $ sum of all sides                        \\[1.5ex]
                              & $\!\!\!\!\!= 10 + 4\sqrt{5}$                 
                \end{tabular}
            \end{minipage}
    ...
    \begin{frame}{Geometric figures}
        \begin{center}        
            ...
            \end{minipage}\hfill\begin{minipage}{0.49\textwidth} \footnotesize
                \begin{tabular}{ll}
                    {\small \textbf{Pick's Theorem:}}  &                   \\[4ex]                
    ...
    \begin{frame}{The Egyptian Four--Triangle--Tangram}
        \begin{center}
            ...
            \begin{tabular}{llrcc}
                \includegraphics[scale=0.25]{figures/figure013s.pdf} &
    ...
    \begin{frame}{The Egyptian Three--Triangle--Tangram}
        \begin{center}
            ...
            \includegraphics[scale=0.39]{figures/figure004m.pdf}\qquad
    ...
    \begin{frame}{The Egyptian Three--Triangle--Tangram}
        \begin{center}
            ...
            {\small ...you can make a rectangle with three similar triangles:\\{\footnotesize $(a^{2},ab,ac)$,\; $(ba,b^{2},bc)$\; \&\; $(ca,cb,c^{2})$} and compare the top {\footnotesize($a^{2}\!+\!b^{2}$)}\\and the bottom {\footnotesize($c^{2}$)} sides of the rectangle to proof Pythagoras}
