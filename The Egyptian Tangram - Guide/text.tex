...
\begin{document}
    ...
    \begin{frame}{Figures with unique solutions}
        ...
        \begin{center}
            ...
            \includegraphics[scale=0.45]{figures/figure022e.pdf}\qquad
            \includegraphics[scale=0.45]{figures/figure022f.pdf}\qquad
            \includegraphics[scale=0.45]{figures/figure022u.pdf} \\
    ...
    \begin{frame}{Quadrilaterals}
        ...
        \begin{center}
            ...
            \only<06>{\textbf{Tangencial quadrilaterals:} All sides are tangent to a circle\phantom{/}\\}
        ...
        \begin{center}
            ...
            \only<03>{\hfill \footnotesize $2ab + c^2 + d^2 = p^2 + q^2$\\}
            ...
            \only<06>{\small Tangencial $\quad\Leftrightarrow\quad a+c = b+d$\\}
            \only<07>{\small Isosceles trapezoids = Cyclic quadrilaterals with equal diagonals\\}
            \only<08>{\small Darts \& Kites = Tangential quadrilaterals with pendicular diagonals\\}
            \only<09>{\small Rhombi = Parallelograms with perpendicular diagonals\\}
            \only<10>{\small Rectangles = Parallelograms with equal diagonals\\}
    ...
    \begin{frame}{The 11 complex quadrilaterals}
        \vspace{-1em}
        \begin{center}
    ...
    \begin{frame}{Q4 is a cyclic quadrilateral}
        \begin{center}
            Since oposite angles add to \textpi...
        \end{center}
        \vspace{0.90em}
    ...
    \begin{frame}{References (by date)}
        \begin{center}
            ...
            \begin{itemize}
                ...
                \item Rajput, C. -- \emph{``A Classical Geometric Relationship That Reveals\\\qquad\qquad The Golden Link in Nature''} (2019)
            \end{itemize}}
