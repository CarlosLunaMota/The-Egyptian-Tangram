...
\begin{document}
    ...
    \begin{frame}{Triangle paradox --- I}
        \begin{center}
            ...
            Where did the triangle go?
        \end{center}
    \end{frame}

    %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

    \begin{frame}{Triangle paradox --- II}
        \begin{center}
            Both figures use all 5 pieces...
    ...
    \begin{frame}{Triangle paradox --- III}
        \begin{center}
            Both figures use all 5 pieces...
    ...
    \begin{frame}{Square paradox --- III}
        \begin{center}
            Both figures use all 5 pieces...
