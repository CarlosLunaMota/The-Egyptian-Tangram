...
\begin{document}
    ...
    \begin{frame}{The Egyptian Four--Triangle--Tangram}
        \begin{center}
            ...
            \begin{tabular}{llrcc}
                ...
                \includegraphics[scale=0.25]{figures/figure023k.pdf} &
                \includegraphics[scale=0.25]{figures/figure023n.pdf} &
                \includegraphics[scale=0.25]{figures/figure023o.pdf} &
                ...
                \includegraphics[scale=0.25]{figures/figure023p.pdf}\!\!\!\!\!\!\! &
                \includegraphics[scale=0.25]{figures/figure023m.pdf} &
                \includegraphics[scale=0.25]{figures/figure023l.pdf} &
    ...
    \begin{frame}{The carpets theorem}
        \begin{center}
            ...
            \raisebox{6.1ex}{%
            \begin{tabular}{c}%
            \only<01>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0083bb.pdf}}\\[1ex]}%
            \only<02>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0066b.pdf}}\\[1ex]}%
            \only<03>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0095b.pdf}}\\[1ex]}%
            \only<04>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0137b.pdf}}\\[1ex]}%
            \only<05>{\rotatebox[origin=c]{180}{\includegraphics[scale=0.4]{carpets/0037bb.pdf}}\\[1ex]}%
            \only<06>{\rotatebox[origin=c]{090}{\includegraphics[scale=0.4]{carpets/0115b.pdf}}\\[1ex]}%
            \only<07>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0061bb.pdf}}\\[1ex]}%
            \only<01>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0083yy.pdf}}}%
            \only<02>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0066y.pdf}}}%
            \only<03>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0095y.pdf}}}%
            \only<04>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0137y.pdf}}}%
            \only<05>{\rotatebox[origin=c]{180}{\includegraphics[scale=0.4]{carpets/0037yy.pdf}}}%
            \only<06>{\rotatebox[origin=c]{090}{\includegraphics[scale=0.4]{carpets/0115y.pdf}}}%
            \only<07>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.4]{carpets/0061yy.pdf}}}%
            \end{tabular}%
            \Large $\left.\parbox[c][14.5ex]{1ex}{}\right\}\mathbf{\Rightarrow}$}
            \only<01>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0083gg.pdf}}}%
            \only<02>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0066g.pdf}}}%
            \only<03>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0095g.pdf}}}%
            \only<04>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0137g.pdf}}}%
            \only<05>{\rotatebox[origin=c]{180}{\includegraphics[scale=0.7]{carpets/0037gg.pdf}}}%
            \only<06>{\rotatebox[origin=c]{090}{\includegraphics[scale=0.7]{carpets/0115g.pdf}}}%
            \only<07>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0061gg.pdf}}}
            \raisebox{6.1ex}{\Large $\mathbf{\Rightarrow}$}
            \only<01>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0083kk.pdf}}}%
            \only<02>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0066k.pdf}}}%
            \only<03>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0095k.pdf}}}%
            \only<04>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0137k.pdf}}}%
            \only<05>{\rotatebox[origin=c]{180}{\includegraphics[scale=0.7]{carpets/0037kk.pdf}}}%
            \only<06>{\rotatebox[origin=c]{090}{\includegraphics[scale=0.7]{carpets/0115k.pdf}}}%
            \only<07>{\rotatebox[origin=c]{000}{\includegraphics[scale=0.7]{carpets/0061kk.pdf}}}%
