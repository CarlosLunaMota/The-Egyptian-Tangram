...
def figura012a():
    ...
    drawing.append((path.path(path.moveto(*A),
                              ...
                              path.lineto(*D),
                              path.moveto(*F),
                              path.lineto(*G)), BASE+THICK+COLOR(RED)+DASHED))
    drawing.append((path.path(path.moveto(*E),
                              path.lineto(*H),
...
def figura013a():
    ...
    drawing.append((path.path(path.moveto(*A),
                              path.lineto(*C),
                              path.moveto(*B),
                              path.lineto(*D)), BASE+THICK+COLOR(RED)+DASHED))
    drawing.append((path.path(path.moveto(*E),
                              path.lineto(*F),
                              path.lineto(*G),
                              path.lineto(*H),
                              path.closepath()), BASE+THICK+COLOR(RED)+DASHED))
    drawing.append((path.path(path.moveto(*F),
                              path.lineto(*H),
                              path.moveto(*E),
...
def figura016d():
    ...
    drawing.append((path.path(path.moveto(*E),
                              ...
                              path.lineto(*H),
                              path.moveto(*F),
                              path.lineto(*C)), BASE+THICK+COLOR(color.rgb.blue)+DOTTED))
    drawing.append((path.path(path.moveto(*A),
                              path.lineto(*B),
                              path.lineto(*C),
                              path.lineto(*D),
...
def figura016f():
    ...
    drawing.append((path.path(path.moveto(*A),
                              path.lineto(*C),
                              path.moveto(*B),
                              path.lineto(*D)), BASE+THICK+COLOR(color.rgb.blue)+DOTTED))
    drawing.append((path.path(path.moveto(*A),
                              path.lineto(*B),
                              path.lineto(*C),
                              path.lineto(*D),
...
def figura019():
    '''El Tangram Egípci - 4 cercles notables'''
    ...
    drawing = []
    drawing.append((path.path(path.moveto(*C),
                              path.arc(X,0, X, 90, 180)), BASE+THICK+COLOR(color.rgb.blue)))
    drawing.append((path.path(path.moveto(*B),
                              path.arc(X/2.0,X, X/2.0, 180, 360)), BASE+THICK+COLOR(color.rgb.green)))
